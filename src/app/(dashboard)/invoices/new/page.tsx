...
import { createInvoiceSchema, type CreateInvoice } from "@/lib/validations/invoice";
...
export default function NewInvoicePage() {
  ...
  const { data: jobsData } = api.jobs.list.useQuery({ take: 50, skip: 0 });
  ...
  const onSubmit = useCallback(
    (data: CreateInvoice) => createMutation.mutate(data),
    [createMutation]
  );
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Input id="dueDate" type="date" className="w-48" {...form.register("dueDate")} />
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent className="space-y-3">
            ...
            {fields.map((field, index) => (
              <div
                key={field.id}
                className="grid grid-cols-1 gap-2 sm:grid-cols-[1fr_100px_130px_44px] sm:gap-3 sm:items-start"
              >
                <div>
                  <Input
